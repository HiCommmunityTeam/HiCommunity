        ...
        public virtual object DeserializeOne(string objRaw)
        {
            ...
            if (fieldTypeMatch.Success)
            {
                ...
                else
                {
                    ...
                    {
                        typeData = Jil.JSON.Deserialize<Type>(typeInfoString);
                    ...
                    return Jil.JSON.Deserialize(objRaw.Substring(fieldTypeMatch.Length), typeData);
                    //return JsonConvert.DeserializeObject(objRaw.Substring(fieldTypeMatch.Length), typeData);
                }
            }
            else
            {
        ...
        public virtual string SerializeOne(string key, object origObj)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    typeInfo = Jil.JSON.SerializeDynamic(objType);
                }
                
                //string objInfo = JsonConvert.SerializeObject(origObj);
                string objInfo = Jil.JSON.SerializeDynamic(origObj);
